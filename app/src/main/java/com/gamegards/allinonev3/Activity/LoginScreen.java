...
//                        btn_bottom_sheet.setText("Expand Sheet");
    ...
    private void CALL_API_TO_VERIFY_SOCIELLOGIN(String social_id, String social_name, String social_email, String trim) {
    }
...
//            CALL_API_TO_VERIFY_SOCIELLOGIN(id, fname +" "+ lname, email);
    ...
    int login_type = -1;
    private void hell (String id, String name, String email,String gender) {
