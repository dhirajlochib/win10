...
import com.gamegards.allinonev3._LuckySpinner.LuckySpinnerActivity;
import com.gamegards.allinonev3._LudoGame.LudoGame;
...
public class Homepage extends AppCompatActivity {
    ...
    ImageView imgpublicGame, imgPrivategame, ImgCustomePage, imgSpinner, ImgVariationGane,iv_andher, ludoGame;
...
//                DialogUserInfo();
        ...
        ludoGame = (ImageView) findViewById(R.id.ludoGameButton);
...
//                LoadTableFragments(ActiveTables_BF.RUMMY5);
        ...
        ludoGame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d("[LUDO_GAME]", "Button Pressed");
               startActivity(new Intent(context, LudoGame.class));
            }
        });
        ...
        imgSpinner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d("[SPINNER_GAME]", "Button Pressed");
                startActivity(new Intent(context, LuckySpinnerActivity.class));
            }
        });
